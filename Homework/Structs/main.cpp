...
struct Student
{
    ...
    void Display()
    {
		...
		cout << "\t" << "    Classes " << classes[0] << " " << classes[1] << " " << classes[2] << " " << classes[3];
        cout << endl;
    }
};
...
void DisplayStudents( const Student* studentList, int studentCount )
{
    for ( int i = 0; i < studentCount; i++ )
    {
		...
		cout << i << ". \t " << setw(20)
			...
			<< "Classes " << studentList[i].classes[0] << " " << studentList[i].classes[1]
			<< " " << studentList[i].classes[2] << " " << studentList[i].classes[3];
...
int main()
{
    ...
    while ( !done )
    {
        ...
        {
			cout << "Enter new Classes One:";
			cin >> students[ modifyIndex ].classes[0];

			cout << "Enter new Classes two:";
			cin >> students [modifyIndex ].classes[1];

			cout << "Enter new Classes three:";
			cin >> students[modifyIndex].classes[2];

			cout << "Enter new Classes four:";
